...
@section('content')
                        ...
                        <div class="card-body">
                            <div class="row justify-content-center">
                                ...
                                <div class="col-sm-2 col-12 d-none">
                                    <label for="agent">Search By Branch</label>
                                    <div class="input-group">
                                        <input type="text" name="agent" id="agent" class="form-control" placeholder="Search by Branch">
                                    </div>
                                </div>
                                <div class="col-sm-4 col-12">
    ...
    <!-- /.content -->
    @include('admin.page.order.modals.invoice_view')
@endsection
...
@push('js')
    <script>
        ...
        $(function() {
            ...
            $("#user_name, #agent").on("keyup", function() {
                dataTable.ajax.reload();
            });
        ...
        function status(id, status, order_status){
            ...
            Swal.fire({
                ...
                if (result.value == true) {
                    var url = "{{ route('admin.order.status', [':id', ':status', ':order_status']) }}";
                    ...
                    $.ajax({
                        ...
                        success: function(data) {
                            if(data === 'stock_out'){
                                Swal.fire({
                                    title: 'Stock Out !',
                                    text: 'Some Products Are Stock Out. Please Check Your Stock List.',
                                    icon: 'warning',
