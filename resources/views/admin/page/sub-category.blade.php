                ...
                <div class="col-md-12">
                    <div class="card card-secondary">
                        <div class="card-header">
                            ...
                            <div class="row w-100" style="justify-content: space-between !important;">
                                <div class="col-6" style="vertical-align: middle; margin: auto;">
                                    <h3 class="card-title text-dark">Sub Category</h3>
                                </div>
                                <div class="col-6 text-right">
                                    <button type="button" id="addSubCategoryModalBtn"  class="btn btn-success text-right m-3"><i class="fas fa-plus-circle"></i> Add New</button>
                                </div>
                            </div>
                        </div>
                        <!-- /.card-header -->
