    ...
    <script>
        ...
        function addCountry(){
            ...
            $.ajax({
                ...
                url: "{{ route('admin.settings.division.store') }}",
          ...
          function edit(id){
            var url = "{{ route('admin.settings.division.edit', ':id') }}";
        ...
        function UpdateCountry(){
            ...
            var route = "{{ route('admin.settings.division.update', ':id') }}";
        ...
        // Category Delete
        function destroy(id){
            var url = "{{ route('admin.settings.division.destroy', ':id') }}";
            url = url.replace(':id', id);
            Swal.fire({
                title: "Are you sure?",
                ...
                confirmButtonText: "Yes, delete it!"
                    ...
                    if (result.isConfirmed) {
                        $.ajax({
                            ...
                            error: function(){
                                warning_msg('Division Not Found!');
                            }
                        });
                    }
             });
