    ...
    <div class="modal-dialog" role="document">
        <div class="modal-content">
            <div class="modal-header bg-secondary py-3">
                <h5 class="modal-title text-white" id="exampleModalLabel1">Designation Edit</h5>
            ...
            <div class="modal-body">
                ...
                <div class="row">
                    ...
                    <div class="col-12 mb-1">
                        <label for="commission" class="form-label">Team Bonus <span class="text-danger">*</span></label>
                        <input type="number" id="commission" name="commission" class="form-control @error('commission') is-invalid @enderror" value="{{ old('commission') }}" placeholder="Team Bonus"/>
                        <span class="text-danger commissionError"></span>
                    </div>
                    <div class="col-12 mb-1 d-none">
                        <label for="commission1" class="form-label">Without Trade License <span class="text-danger">*</span></label>
                        <input type="number" id="commission1" name="commission1" class="form-control @error('commission1') is-invalid @enderror" value="{{ old('commission1') }}" placeholder="Without Trade License"/>
                        <span class="text-danger commission1Error"></span>
                    </div>
                </div>
            </div>
            <div class="modal-body">
